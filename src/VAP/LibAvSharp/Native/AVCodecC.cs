...
namespace LibAvSharp.Native
{
    ...
    {
        // avcodec_send_packet
        [DllImport(LibNames.LibAvCodec, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LibNames.LibAvCodec, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "avcodec_get_name")]
        ...
        [DllImport(LibNames.LibAvCodec, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
