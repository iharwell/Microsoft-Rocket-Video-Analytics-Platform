...
namespace LibAvSharp
{
    ...
    {
        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_add_i")]
        internal static extern AVInteger av_add_i(AVInteger a, AVInteger b);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_sub_i")]
        internal static extern AVInteger av_sub_i(AVInteger a, AVInteger b);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_log2_i")]
        internal static extern int av_log2_i(AVInteger a);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_mul_i")]
        internal static extern AVInteger av_mul_i(AVInteger a, AVInteger b);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_cmp_i")]
        internal static extern int av_cmp_i(AVInteger a, AVInteger b);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_shr_i")]
        internal static extern AVInteger av_shr_i(AVInteger a, int s);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_mod_i")]
        internal static extern AVInteger av_mod_i(ref AVInteger quot, AVInteger a, AVInteger b);


        [DllImport(LibNames.LibAvUtil, CallingConvention = CallingConvention.Cdecl, EntryPoint = "av_div_i")]
